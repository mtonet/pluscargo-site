...
foreach($result as $key){ 
	 foreach($key as $filho=> $val){
		...
		?>
			...
			<tr>
			  <td width="" bgcolor="#F5F5F5"><strong>M/V</strong></td>
			  <td width="" bgcolor="#F5F5F5"><strong>VG</strong></td>
			  <td width="" bgcolor="#F5F5F5"><strong>ETD</strong></td>
			  <td width="" bgcolor="#F5F5F5"><strong>DEAD LINE</strong></td>
			</tr>
			...
			<tr>
			  ...
			  <td><? echo(substr($elemento['LCLImpoETD3'],8,2) . '/' . substr($elemento['LCLImpoETD2'],5,2) . '/' . substr($elemento['LCLImpoETD2'],0,4)); ?></td>
