	 ...
	 foreach($key as $filho=> $val){
		...
		?>
			...
			<tr>
			  ...
			  <td><? echo(substr($elemento['LCLImpoETA'],8,2) . '/' . substr($elemento['LCLImpoETA'],5,2) . '/' . substr($elemento['LCLImpoETA'],0,4)); ?></td>
			...
			<tr>
			  ...
			  <td><? echo(substr($elemento['LCLImpoETA1'],8,2) . '/' . substr($elemento['LCLImpoETA1'],5,2) . '/' . substr($elemento['LCLImpoETA1'],0,4)); ?></td>
			...
			<tr>
			  ...
			  <td><? echo(substr($elemento['LCLImpoETA2'],8,2) . '/' . substr($elemento['LCLImpoETA2'],5,2) . '/' . substr($elemento['LCLImpoETA2'],0,4)); ?></td>
			...
			<tr>
			  ...
			  <td><? echo(substr($elemento['LCLImpoETA3'],8,2) . '/' . substr($elemento['LCLImpoETA3'],5,2) . '/' . substr($elemento['LCLImpoETA3'],0,4)); ?></td>
