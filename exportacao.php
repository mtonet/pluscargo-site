...
para visualizar os navios programados:</p>
  ...
  <li role="presentation" class="active"><a href="exportacao.php">AFRICA DO SUL</a></li>
  ...
  <li role="presentation"><a href="argentina.php">ARGENTINA</a></li>
    ...
    <li role="presentation"><a href="canada.php">CANADA</a></li>
...
<?php include("includes/exportacao_ws.php");?>
