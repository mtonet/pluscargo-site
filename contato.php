 ...
 <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <h2>Contato</h2>
          <hr>
          <p>Selecionee o escritório que você deseja falar ou nos envie uma mensagem e esclareça todas as suas dúvidas sobre os nossos serviços e consulte nossos fretes.</p>
        </div>                        
      </div>
<hr>
