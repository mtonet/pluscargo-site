...
para visualizar os navios programados:</p>
  ...
  <li role="presentation"  class="active"><a href="itajai.php"  class="active">ITAJAÍ</a></li>
  <li role="presentation"><a href="paranagua.php">PARANAGUÁ</a></li>
    <li role="presentation"><a href="rio.php">RIO DE JANEIRO</a></li>
</ul>
                                                    
               
<?php include("includes/itajai_ws.php");?>
